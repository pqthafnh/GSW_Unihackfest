...
export function AppShell({ role, children }: AppShellProps) {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#f5f5f7]">
      ...
      <footer className="border-t border-black/[0.06] bg-white px-6 py-6 text-center text-xs text-neutral-500">Simulated workspace · no real funds · no blockchain transaction submitted</footer>
    </div>
  );
}
